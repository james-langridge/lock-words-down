...
const Header = () => {
  ...
  const selectionList = useAppSelector(
    (state) => state.selections.selectionList
  );
  ...
  const selectSelection = (selection: Selection) => {
    ...
    const sortedWordList = wordList.reduce(
      (acc: TermEntry[], word: TermEntry) => {
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="me-auto mb-2 mb-md-0 mr-auto">
            <DropdownButton
              ...
              title="Play"
              disabled={
                !(selectedWords.length > 1 && location.pathname === "/list")
              }
              className="mr-2"
            >
            ...
            <DropdownButton title="Words" className="mr-2">
            ...
            <DropdownButton title="Students" className="mr-2">
